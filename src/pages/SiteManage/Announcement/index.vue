          ...
          <div class="row m-b-20 justify-content-end panel-search-box">
            ...
            <div class="col-sm-10 form-inline justify-content-end panel-search">
              <div class="form-group width-100 m-r-10">
                <j-select
                  v-model="search.is_marquee"
                  :datas="options.is_marquee"
                  title="跑马灯"
                />
              </div>
              <div class="form-group width-100 m-r-10">
            ...
            <table class="table  table-striped table-box text-center">
              ...
              <tbody>
                <tr v-for="(data, index) in datas" :key="index">
                  ...
                  <td>
                    <i v-if="data.is_marquee == Const.Y" class="fas fa-lg fa-check-circle text-green" />
                    <i v-else class="fas fa-lg fa-times-circle text-danger" />
                  </td>
                  <td>
                    <i v-if="data.is_top == Const.Y" class="fas fa-lg fa-check-circle text-green" />
                    <i v-else class="fas fa-lg fa-times-circle text-danger" />
                  </td>
                  <td>
